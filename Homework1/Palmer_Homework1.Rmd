...
\newline
\texttt{https://github.com/KarissaPalmer/STAT600/tree/5cbac37a71d6e6458e8a076a8cfc6cd8901d12e3/Homework1/}
\newline
...
When using applying the function \texttt{SimpLinR} and \texttt{lm()} I also used 6 cores each. The function \texttt{SimpLinR} took 0.2370 seconds to go through the simulations and the R function took 0.0957 seconds. The file on Github \texttt{Sim\_Data.RData} has the simulated data whose results may be checked. 
